...
of the [ÐecisionToolkit] maturity, based on a range of performance and reliability criteria.

To assess the maturity of [ÐecisionToolkit], the following key performance indicators has been adopted:
